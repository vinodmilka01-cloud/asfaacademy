            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
                    <div className="lg:w-1/2" data-aos="fade-left">
                        ...
                        <Link href="/paralympics" className="inline-flex items-center gap-2 border-2 border-gray-950 text-gray-950 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-950 hover:text-white transition-all group">
                            Inclusive Sports Details <ArrowRight className="group-hover:translate-x-2 transition-transform" />
                        </Link>
                    </div>
